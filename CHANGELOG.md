# [5.24.0](https://github.com/xChickens/revanced-patches/compare/v5.23.0...v5.24.0) (2025-07-09)


### Bug Fixes

* Add scrollable content to modern style settings dialogs ([#5211](https://github.com/xChickens/revanced-patches/issues/5211)) ([e6876d5](https://github.com/xChickens/revanced-patches/commit/e6876d510d28f6a3a41ec1722a033b3e30a22c65))
* **Bandcamp - Remove play limits:** Support latest app version ([#5124](https://github.com/xChickens/revanced-patches/issues/5124)) ([863e92b](https://github.com/xChickens/revanced-patches/commit/863e92b20ad6682f10524e475ed18f879048ecae))
* Correctly name `Enable ROM signature spoofing` patch ([d85881a](https://github.com/xChickens/revanced-patches/commit/d85881a6768232a999534677bebb248e640fe5ab))
* **Disable Pairip license check:** Change patch to default off ([74b6a94](https://github.com/xChickens/revanced-patches/commit/74b6a94577ac3f73b04bd0cce98fb7011a6607fd))
* Fix accidental changes ([e2ac841](https://github.com/xChickens/revanced-patches/commit/e2ac8419756e3c7d62e2c0430a2918a3c1c63666))
* Fix refactoring typo ([ec0ae42](https://github.com/xChickens/revanced-patches/commit/ec0ae42496628cdeb2a639020fce94316b41b751))
* **Google Photos:** Resolve startup crash for Android 5.0 devices ([0294533](https://github.com/xChickens/revanced-patches/commit/0294533c4d9a321aea086eedb4e46385ae9a026e))
* **Google Photos:** Resolve startup crash if MicroG GmsCore does not already have granted permissions ([a93d74d](https://github.com/xChickens/revanced-patches/commit/a93d74d26e7ef87a3745df2b9fe82722d65a0e59))
* **Hide ADB status:** Resolve app crash on startup ([#5029](https://github.com/xChickens/revanced-patches/issues/5029)) ([1abebd5](https://github.com/xChickens/revanced-patches/commit/1abebd5f3b73250c6638d2d8a274b92ea8268924))
* **Messenger - Remove Meta AI:** Improve patch logic ([#5153](https://github.com/xChickens/revanced-patches/issues/5153)) ([4ad4887](https://github.com/xChickens/revanced-patches/commit/4ad488744d87543c31e453dc7b6d8182b3a7f440))
* **Messenger:** Remove outdated `Disable switching emoji to sticker` patch ([#5044](https://github.com/xChickens/revanced-patches/issues/5044)) ([7b182ca](https://github.com/xChickens/revanced-patches/commit/7b182cab825ee3a4a3ca528c744c9d2a351c7cf8))
* **Pandora - Disable ads:** Support latest app target ([#5185](https://github.com/xChickens/revanced-patches/issues/5185)) ([ca83047](https://github.com/xChickens/revanced-patches/commit/ca83047f5c4acbb267d5b98db80ad111999086e0))
* **SoundCloud:** Constrain patches to last working app target ([e8ea89f](https://github.com/xChickens/revanced-patches/commit/e8ea89fc1a3f0531a0af7529663f13328aca4fe7))
* **Spotify - Custom theme:** Apply accent color in more places ([#5039](https://github.com/xChickens/revanced-patches/issues/5039)) ([9357887](https://github.com/xChickens/revanced-patches/commit/9357887b6fca7aaf34dfb0163645b6a998e1db76))
* **Spotify - Fix third party launchers widgets:** Add missing compatibility annotation ([0493f80](https://github.com/xChickens/revanced-patches/commit/0493f8035b26b90c5f8e42be2e2a5ce73d8685a5))
* **Spotify - Spoof client patch:** Block sending bad integrity verdicts to potentially fix account suspensions ([#5274](https://github.com/xChickens/revanced-patches/issues/5274)) ([f7b574c](https://github.com/xChickens/revanced-patches/commit/f7b574ca79c5a616cfe33a3fc75bd8cf68571f7d))
* **Spotify - Spoof client:** Handle remaining edge cases to obtain a session ([#5285](https://github.com/xChickens/revanced-patches/issues/5285)) ([2bb2d59](https://github.com/xChickens/revanced-patches/commit/2bb2d594936093774e232ad8b274c81e805c5bf6))
* **Spotify - Spoof client:** Skip native login screens ([#5228](https://github.com/xChickens/revanced-patches/issues/5228)) ([c5ebc63](https://github.com/xChickens/revanced-patches/commit/c5ebc6336ed17cc9cc7f1348282a2aa3c173fb95))
* **Spotify - Unlock Premium:** Fix hiding context menu ads on newest versions ([#5318](https://github.com/xChickens/revanced-patches/issues/5318)) ([73fd832](https://github.com/xChickens/revanced-patches/commit/73fd83222e089a5fd6e1526e5c12f5a1e9893a35))
* **Spotify - Unlock Premium:** Fix hiding context menu ads on newest versions by simplifying fingerprint ([#5318](https://github.com/xChickens/revanced-patches/issues/5318)) ([dad0ff4](https://github.com/xChickens/revanced-patches/commit/dad0ff4fba74c2b020fbde6c6d5eb66e10e6f1f7))
* **Spotify Lite:** Remove obsolete `Enable on demand` patch ([#5046](https://github.com/xChickens/revanced-patches/issues/5046)) ([4886d47](https://github.com/xChickens/revanced-patches/commit/4886d47506c94b03c1f190ecc4947d3d91df6a47))
* **Spotify:** `Hide Create button` patch failing in edge cases ([#5131](https://github.com/xChickens/revanced-patches/issues/5131)) ([0923600](https://github.com/xChickens/revanced-patches/commit/0923600739a126329fc62100b500216860d7005e))
* **Spotify:** Add `Spoof client` patch to fix various issues by using a web platform access token ([#5173](https://github.com/xChickens/revanced-patches/issues/5173)) ([b7b75bb](https://github.com/xChickens/revanced-patches/commit/b7b75bb9d8d5fd505121e752b8a20e61ff28d1b2))
* **Spotify:** Fix `Hide Create button` and `Sanitize sharing links` for older but supported app targets ([#5159](https://github.com/xChickens/revanced-patches/issues/5159)) ([e7dd061](https://github.com/xChickens/revanced-patches/commit/e7dd061c513af90861c0ab0d7adc6ee43be57ce2))
* **Spotify:** Prevent hiding all navigation bar buttons ([#5122](https://github.com/xChickens/revanced-patches/issues/5122)) ([8afbef0](https://github.com/xChickens/revanced-patches/commit/8afbef01343c1e3e6e7e4a4cec6319aebfa4b11c))
* **Spotify:** Remove other ads type from the browse screen ([#5333](https://github.com/xChickens/revanced-patches/issues/5333)) ([c68533a](https://github.com/xChickens/revanced-patches/commit/c68533a33a399ca813380b5c9ccddce434ceadf8))
* **Sync for Reddit - Spoof client:** Use www instead of ssl API to fix auth related issues ([6fea672](https://github.com/xChickens/revanced-patches/commit/6fea6720a0b61c2624ab10a1d1b3b01f32ac99d6))
* **Threads - Hide ads:** Constrain patch to the last working app target ([#5189](https://github.com/xChickens/revanced-patches/issues/5189)) ([3558c44](https://github.com/xChickens/revanced-patches/commit/3558c44a05c13f19fefdbbf14b364181a79f17c0))
* **YouTube - GmsCore support:** Restore patch functionality from prior merge ([7686bbe](https://github.com/xChickens/revanced-patches/commit/7686bbe975644e1e582fa52f166879da5694ed93))
* **YouTube - Hide ads:** Fix "Hide shopping links" ([#5267](https://github.com/xChickens/revanced-patches/issues/5267)) ([2fe4607](https://github.com/xChickens/revanced-patches/commit/2fe46079d78ab98076d3a4cdf01c8bfdbdea45c0))
* **YouTube - Hide ads:** Hide new type of general ad ([#5004](https://github.com/xChickens/revanced-patches/issues/5004)) ([37e59d2](https://github.com/xChickens/revanced-patches/commit/37e59d2771528c631dc13e73dac095fec95c6485))
* **YouTube - Hide ads:** Hide new type of general ad ([#5345](https://github.com/xChickens/revanced-patches/issues/5345)) ([f23716b](https://github.com/xChickens/revanced-patches/commit/f23716bc52c03d8d0271bfe38b19247e6de7021d))
* **YouTube - Hide ads:** Hide new type of product ad in video description ([#5225](https://github.com/xChickens/revanced-patches/issues/5225)) ([1e2efad](https://github.com/xChickens/revanced-patches/commit/1e2efad7b2714c395ed6b0a77cbbf8a2265df520))
* **YouTube - Hide layout components:** Do not hide playlist sort button if 'Hide AI comments summary' is on ([5f3e48e](https://github.com/xChickens/revanced-patches/commit/5f3e48ec5853f6439800ef58239291c34bcab5f6))
* **YouTube - Hide layout components:** Fix "Hide AI Comments summary" in Comments ([#5284](https://github.com/xChickens/revanced-patches/issues/5284)) ([d42370e](https://github.com/xChickens/revanced-patches/commit/d42370ef71f4608abc64b6ef4a3fb0c5bd5e3eb6))
* **YouTube - Hide layout components:** Fix "Hide AI-generated video summary" in video description ([#5269](https://github.com/xChickens/revanced-patches/issues/5269)) ([5203da0](https://github.com/xChickens/revanced-patches/commit/5203da0ae58e467657bc915ab0af5b9904c4f492))
* **YouTube - Hide layout components:** Fix "Hide ticket shelf" hiding unwanted components ([#5292](https://github.com/xChickens/revanced-patches/issues/5292)) ([d6b1f7a](https://github.com/xChickens/revanced-patches/commit/d6b1f7a6e18b1c0eb4374c5e22a1c746dcb3a522))
* **YouTube - Hide layout components:** Fix "Hide video description attributes" ([#5250](https://github.com/xChickens/revanced-patches/issues/5250)) ([2f22d45](https://github.com/xChickens/revanced-patches/commit/2f22d45eb80745ac64fbea44c8055ebe7925a586))
* **YouTube - Hide layout components:** Fix `Hide video recommendation labels` ([#4956](https://github.com/xChickens/revanced-patches/issues/4956)) ([ae05ac3](https://github.com/xChickens/revanced-patches/commit/ae05ac38151ebd3197953af97ca0dd847a04cc2d))
* **YouTube - Hide layout components:** Remove broken option 'Hide comments emoji picker' ([#5121](https://github.com/xChickens/revanced-patches/issues/5121)) ([9a6a639](https://github.com/xChickens/revanced-patches/commit/9a6a639c4905b00d6dffb0923c839c8e3ae54d0c))
* **YouTube - Hide Shorts components:** Disable A/B player flags that prevents hiding buttons ([bef0dac](https://github.com/xChickens/revanced-patches/commit/bef0dacac54caf1ca9511d7bc19b19140ccb4eaf))
* **YouTube - Hide Shorts components:** Disable A/B player that prevents hiding buttons ([#5104](https://github.com/xChickens/revanced-patches/issues/5104)) ([835b7bd](https://github.com/xChickens/revanced-patches/commit/835b7bd7bd667abd632822c98898972e5124dbb6))
* **YouTube - Hide Shorts components:** Fix "Hide Use this sound button" ([#5233](https://github.com/xChickens/revanced-patches/issues/5233)) ([5d6ec9e](https://github.com/xChickens/revanced-patches/commit/5d6ec9e94a6221a0f32762d5bede893e9e7457fc))
* **YouTube - Hide Shorts components:** Fix "Hide Use this template button" ([#5249](https://github.com/xChickens/revanced-patches/issues/5249)) ([b399ecb](https://github.com/xChickens/revanced-patches/commit/b399ecbb6a222d82dd5e4b3417c9f7eff4324adb))
* **YouTube - Hide Shorts components:** Fix hiding of untoggled components ([#5266](https://github.com/xChickens/revanced-patches/issues/5266)) ([008e192](https://github.com/xChickens/revanced-patches/commit/008e192779a8658e894d5718baa732717bf96e40))
* **YouTube - Open Shorts in regular player:** Do not exit app when pressing back button in regular player ([#5020](https://github.com/xChickens/revanced-patches/issues/5020)) ([3384f8d](https://github.com/xChickens/revanced-patches/commit/3384f8dd0ff2a345f2e387f4ed1570079a83ccb6))
* **YouTube - Playback speed:** Allow custom speeds with 0.01x precision ([#5360](https://github.com/xChickens/revanced-patches/issues/5360)) ([0eecef0](https://github.com/xChickens/revanced-patches/commit/0eecef00fc93d2a217944978e29dce82e3134e35))
* **YouTube - Settings:** Correctly show summary text if search box is closed before searching ([d0ae835](https://github.com/xChickens/revanced-patches/commit/d0ae835d3381fc659c9bb4a2d130d4db8a1499cf))
* **YouTube - SponsorBlock:** Do not show undo skip if PiP is active ([#5314](https://github.com/xChickens/revanced-patches/issues/5314)) ([18af8de](https://github.com/xChickens/revanced-patches/commit/18af8dead2c6c7f0d99cd75b69948240e0bcd12c))
* **YouTube - SponsorBlock:** Fix segment category summary not showing category description ([06934a6](https://github.com/xChickens/revanced-patches/commit/06934a60d91b40a5cdf7f4cd92deae4a136c149b))
* **YouTube - Video quality:** Remove non-functional Shorts 144p default quality ([3113cd6](https://github.com/xChickens/revanced-patches/commit/3113cd6d092952c8657454452f34c0ae85358ec9))
* **YouTube:** Always use single threaded layout to resolve layout bugs in unpatched YouTube ([#5226](https://github.com/xChickens/revanced-patches/issues/5226)) ([1f539b1](https://github.com/xChickens/revanced-patches/commit/1f539b1396526b2c767d77a804bd0308ee4a42ec))
* **YouTube:** Better handle incorrect duplicate translations ([20abac5](https://github.com/xChickens/revanced-patches/commit/20abac52121fbecb65d87d0982f3380e1cf4e20e))
* **YouTube:** Fix refactoring app startup exception ([1b00c90](https://github.com/xChickens/revanced-patches/commit/1b00c907f4b90f4659afb4a54ba61ac2835b460d))
* **YouTube:** Remove old app targets that are no longer supported by YouTube ([#5192](https://github.com/xChickens/revanced-patches/issues/5192)) ([c9e54e1](https://github.com/xChickens/revanced-patches/commit/c9e54e1d36243945ac1ec3108fe38edf0e15d772))
* **YouTube:** Support A/B Shorts layout for RYD and component hiding ([#5081](https://github.com/xChickens/revanced-patches/issues/5081)) ([8ecacaa](https://github.com/xChickens/revanced-patches/commit/8ecacaad27162d9380014a9a13ac9220b12257b2))
* **Yuka - Unlock premium:** Remove broken patch that is no longer supported ([#5018](https://github.com/xChickens/revanced-patches/issues/5018)) ([fac6e59](https://github.com/xChickens/revanced-patches/commit/fac6e59d281e21e57abdcfc899cd1aeb18e5c2b8))


### Features

* Add `Disable pairip license check` patch ([#4927](https://github.com/xChickens/revanced-patches/issues/4927)) ([42d2c27](https://github.com/xChickens/revanced-patches/commit/42d2c277982ef63e6ad42d85e46f13c3ab50243c))
* Add `Hide app icon` patch ([#4977](https://github.com/xChickens/revanced-patches/issues/4977)) ([92311b8](https://github.com/xChickens/revanced-patches/commit/92311b8e5675f3d4b80ed690d34b699fb847e3cd))
* Add `Spoof app signature` patch ([#5158](https://github.com/xChickens/revanced-patches/issues/5158)) ([78b25aa](https://github.com/xChickens/revanced-patches/commit/78b25aa4e87ec3f9df1d57831b48a39029969416))
* **Cricbuzz:** Add `Hide ads` patch ([#4998](https://github.com/xChickens/revanced-patches/issues/4998)) ([83ccfa8](https://github.com/xChickens/revanced-patches/commit/83ccfa8e1b5d5a44c55ef659484acf3cc08d3346))
* **Crunchyroll:** Add `Hide ads` patch ([#5201](https://github.com/xChickens/revanced-patches/issues/5201)) ([46b4398](https://github.com/xChickens/revanced-patches/commit/46b4398fd6ca223391ed8f497a8347c2313421b7))
* **GmsCore support:** Open vendor specific DontKillMyApp if available ([#4952](https://github.com/xChickens/revanced-patches/issues/4952)) ([b89927a](https://github.com/xChickens/revanced-patches/commit/b89927a10e3b909a3c37fbb75c16a7abbce44560))
* **Google Photos:** Add `Enable DCIM folders backup control` patch ([#5138](https://github.com/xChickens/revanced-patches/issues/5138)) ([328d232](https://github.com/xChickens/revanced-patches/commit/328d232fe77406fa93a14768fc66e7b998506fba))
* **Lightroom:** Constrain patches to last working version ([#5335](https://github.com/xChickens/revanced-patches/issues/5335)) ([32ce70e](https://github.com/xChickens/revanced-patches/commit/32ce70e994f354b9a569376bb89eb38b3190e6f9))
* **Messenger:** Add `Hide Facebook button` patch ([#5057](https://github.com/xChickens/revanced-patches/issues/5057)) ([9175b23](https://github.com/xChickens/revanced-patches/commit/9175b23e8360d13c8c1c9c8602ca0b5931d13627))
* **Messenger:** Add `Remove Meta AI` patch ([#4945](https://github.com/xChickens/revanced-patches/issues/4945)) ([012dff7](https://github.com/xChickens/revanced-patches/commit/012dff7b6511b9e519ccac96f6713cf1a1b327b4))
* **NU.nl:** Support version `11.3.0` ([#4925](https://github.com/xChickens/revanced-patches/issues/4925)) ([bedde60](https://github.com/xChickens/revanced-patches/commit/bedde60fc1a52b0fd491174b3b5b887435eb621a))
* **Prime Video:** Add `Rename shared permissions` patch ([#5049](https://github.com/xChickens/revanced-patches/issues/5049)) ([80f1fc6](https://github.com/xChickens/revanced-patches/commit/80f1fc629e30e391bd5877f07dbdf4b6613bd1cf))
* **Proton Mail:** Add `Remove free accounts limit` patch ([#4970](https://github.com/xChickens/revanced-patches/issues/4970)) ([b0440ad](https://github.com/xChickens/revanced-patches/commit/b0440ad6af0e190e516974ce896dcc54c8d2e122))
* **Spotify:** Add `Change lyrics provider` patch ([#4937](https://github.com/xChickens/revanced-patches/issues/4937)) ([8736b6a](https://github.com/xChickens/revanced-patches/commit/8736b6a80b48cb1f4562c9f9919804006ddb18bd))
* **Spotify:** Add `Fix Facebook login` patch ([#5023](https://github.com/xChickens/revanced-patches/issues/5023)) ([34932dc](https://github.com/xChickens/revanced-patches/commit/34932dc43933d346a5a3adadc62c0dbd38a633b5))
* **Spotify:** Add `Fix third party launchers widgets` patch ([#4893](https://github.com/xChickens/revanced-patches/issues/4893)) ([23bfdc9](https://github.com/xChickens/revanced-patches/commit/23bfdc98fbbcc8ecf0ffbf8704f58dd2272e4af2))
* **Spotify:** Add `Hide Create button` patch ([#5062](https://github.com/xChickens/revanced-patches/issues/5062)) ([3201681](https://github.com/xChickens/revanced-patches/commit/32016819d2adbdfdd5e028941d56feda36d20b00))
* **Spotify:** Remove ads section from browse ([#5193](https://github.com/xChickens/revanced-patches/issues/5193)) ([ebd4dcc](https://github.com/xChickens/revanced-patches/commit/ebd4dccf12a5fbd31d2d53c19a792c389a4641d7))
* **Sync for Reddit:** Add `Fix post thumbnails` patch ([e1ec30c](https://github.com/xChickens/revanced-patches/commit/e1ec30c5b07560a39d7b8ab293b0c1f39fd59ef2))
* **Threads:** Hide Ads ([#5064](https://github.com/xChickens/revanced-patches/issues/5064)) ([3c4cecb](https://github.com/xChickens/revanced-patches/commit/3c4cecb966c2f99bfde99552686dda19ade5f67e))
* Use modern style settings dialogs ([#5109](https://github.com/xChickens/revanced-patches/issues/5109)) ([312b6dc](https://github.com/xChickens/revanced-patches/commit/312b6dc04e01c2758cd304ca8606306027aa2f01))
* **YouTube - Change header:** Add in-app setting to change the app header ([#5346](https://github.com/xChickens/revanced-patches/issues/5346)) ([9ba45b6](https://github.com/xChickens/revanced-patches/commit/9ba45b6680595d732b47e8fa54bee98b7c7af179))
* **YouTube - Enable debugging:** Add settings menu to share debug logs ([#5021](https://github.com/xChickens/revanced-patches/issues/5021)) ([1ec4a88](https://github.com/xChickens/revanced-patches/commit/1ec4a88464a2a2810c02cf072950b618d183779a))
* **YouTube - Hide description components:** Add `Hide Ask` ([#4972](https://github.com/xChickens/revanced-patches/issues/4972)) ([ebc94a5](https://github.com/xChickens/revanced-patches/commit/ebc94a5da6214b67399c9c01515689bd4b20547c))
* **YouTube - Hide layout components:** Add `Hide channel links preview` and `Hide 'Visit Community' button` in channel page ([#5320](https://github.com/xChickens/revanced-patches/issues/5320)) ([9d9cce3](https://github.com/xChickens/revanced-patches/commit/9d9cce3ec5550b2fea88df745f1700bb2f17eb9e))
* **YouTube - Hide layout components:** Add `Hide in history` option to filter bar ([#5271](https://github.com/xChickens/revanced-patches/issues/5271)) ([ba242a3](https://github.com/xChickens/revanced-patches/commit/ba242a36b040b82e84870e5e240734637125a472))
* **YouTube - Hide layout components:** Add `Hide ticket shelf` ([#4969](https://github.com/xChickens/revanced-patches/issues/4969)) ([6436af7](https://github.com/xChickens/revanced-patches/commit/6436af7e77c77d2034dfceba8bc51132ad7632be))
* **YouTube - Hide player components:** Hide related video overlay in fullscreen ([#4938](https://github.com/xChickens/revanced-patches/issues/4938)) ([ac9be97](https://github.com/xChickens/revanced-patches/commit/ac9be9760c9965e54df196b227a310d64ead4bf5))
* **YouTube - Hide player overlay buttons:** Add in app setting for "Hide player control buttons background" ([#5147](https://github.com/xChickens/revanced-patches/issues/5147)) ([dd8afa2](https://github.com/xChickens/revanced-patches/commit/dd8afa2b07b50be24d764c0f6ddc9e1bbdb91bf1))
* **YouTube - Hide Shorts components:** Add `Hide Effects button` ([#5255](https://github.com/xChickens/revanced-patches/issues/5255)) ([240897a](https://github.com/xChickens/revanced-patches/commit/240897a94008ce9a148c87bb41b978d553d5a6f5))
* **YouTube - Hide Shorts components:** Add hide 'New posts' button ([ac6b916](https://github.com/xChickens/revanced-patches/commit/ac6b916c0c212167c4645e2110500dc811b3e54a))
* **YouTube - Hide Shorts components:** Add option to hide comment panel ([#5102](https://github.com/xChickens/revanced-patches/issues/5102)) ([22b9bee](https://github.com/xChickens/revanced-patches/commit/22b9beedd3243a8d6a5635f591b91cdcf307be37))
* **YouTube - Hide video action buttons:** Add `Hide Stop ads` ([#5245](https://github.com/xChickens/revanced-patches/issues/5245)) ([274dcc6](https://github.com/xChickens/revanced-patches/commit/274dcc676e009be63eb6970de33abacd34dc6560))
* **YouTube - Playback Speed:** Use modern custom speed dialog ([#5069](https://github.com/xChickens/revanced-patches/issues/5069)) ([9a1e6ca](https://github.com/xChickens/revanced-patches/commit/9a1e6ca178d9833ee2c681fb130b9290a4e89cd8))
* **YouTube - Settings:** Add a color picker ([#4981](https://github.com/xChickens/revanced-patches/issues/4981)) ([1e0e398](https://github.com/xChickens/revanced-patches/commit/1e0e398574329173aff11a4dc9acfc3fcdeabe16))
* **YouTube - Settings:** Add ability to search in settings ([#4881](https://github.com/xChickens/revanced-patches/issues/4881)) ([aca8b20](https://github.com/xChickens/revanced-patches/commit/aca8b207c15f254bcc9ad94bc7dfb895f21d4058))
* **YouTube - SponsorBlock:** Add "Undo automatic skip toast" ([#5277](https://github.com/xChickens/revanced-patches/issues/5277)) ([7fa169a](https://github.com/xChickens/revanced-patches/commit/7fa169ae262c880019c5a069a2d6bdc7f94885f1))
* **YouTube - Swipe controls:** Add separate color settings for the brightness and volume bars ([#5043](https://github.com/xChickens/revanced-patches/issues/5043)) ([80f50e8](https://github.com/xChickens/revanced-patches/commit/80f50e8c50ca6a8366b7fd7b01459fb16fa1074a))
* **YouTube - Theme:** Add option for black and white splash screen animation ([#5119](https://github.com/xChickens/revanced-patches/issues/5119)) ([42db0c2](https://github.com/xChickens/revanced-patches/commit/42db0c2e36fefccdbeaa072edcec48b1e05b6270))
* **YouTube:** Add `Disable haptic feedback` patch ([#5033](https://github.com/xChickens/revanced-patches/issues/5033)) ([bbe7974](https://github.com/xChickens/revanced-patches/commit/bbe79744a513c96f9016476e8435f999e94c45d7))
* **YouTube:** Add an option to disable toasts when changing default playback speed or quality ([#5230](https://github.com/xChickens/revanced-patches/issues/5230)) ([c68cde3](https://github.com/xChickens/revanced-patches/commit/c68cde3a896450874cc571be5c4723387db96032))
* **YouTube:** Support version `20.13.41` ([#5253](https://github.com/xChickens/revanced-patches/issues/5253)) ([d284c3d](https://github.com/xChickens/revanced-patches/commit/d284c3dd3277430b6885e7c27ee02d062dcefc85))
